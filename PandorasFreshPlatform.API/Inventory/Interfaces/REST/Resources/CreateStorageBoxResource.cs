...
/// <summary>
/// Create storage box resource for REST API
/// </summary>
/// <param name="Label">
...
/// </param>
public record CreateStorageBoxResource(string Label, int MaxCapacity, int CurrentCapacity, string TemperatureRange);